...
import { colorFillMapping } from '@/pages/product/[productSlug]';
...
export const Product: React.FC<ProductProps> = ({
  ...
  return (
    <Link href={linkTo} className={classNames('group block', className)}>
      ...
      {/* colors ce imat kad se zove na shop pageu pa ce bit u redu title i cijena, na product slagu ce cijenu ispisat ispod naslova
      ovo je bia pokusaj za ove hovere s bojama */}
      {/* {colors ? ( */}
          ...
          <li>
            <button>
              <svg
                ...
                fill="none"
              >
                <g fill={colorFillMapping[color]} clipPath="url(#a)">
